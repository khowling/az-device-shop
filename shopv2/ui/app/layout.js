      ...
      <html lang="en">
        ...
        <header className="bg-white">
          <div className="container mx-auto px-6 py-3">
              ...
              <nav className={`sm:flex sm:justify-center sm:items-center mt-4 ${false ? '' : 'hidden'}`} >
              ...
              <div className="relative mt-6 max-w-lg mx-auto">
                  ...
                  <input className="pl-10 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" type="text" placeholder="Search"/>
              </div>
          </div>
        </header>
