...
function startup() {
    return __awaiter(this, void 0, void 0, function () {
        function avail_capacity() {
            return factory_capacity - orders_in_factory.reduce(function (ival, cval) { return ival + cval.qty; }, 0);
        }
        var db, factory_capacity, orders_in_factory;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    orders_in_factory = [];
                    // watch
                    watch(db, "workitems", function (doc) {
                        console.log(doc);
                        if (doc.status === "Planned" && avail_capacity() >= doc.qty) {
                            console.log('lets start the workitem');
                            ...
                            orders_in_factory.push(doc);
                            db.workitems.updateOne({ _id: ObjectID(doc._id), partition_key: "TEST" }, { $set: { status: "InFactory" } }, { upsert: false, returnOriginal: false, returnNewDocument: false });
                        }
                    });
                    return [2 /*return*/];
            }
